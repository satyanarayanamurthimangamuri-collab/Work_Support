...
const FAQS = [
  ["What kind of problems can I get help with?", "Work Support focuses on technical, project, learning and professional-development problems, from a broken workflow to planning your next skill."],
  ["Is Work Support suitable for beginners?", "Yes. Guidance can be adapted to your current level, with concepts explained clearly and at a useful pace."],
  ...
  ["How do I request support?", "Use the Get Work Support button, send a message through the contact page or reach out directly on WhatsApp."],
...
export default function WorkSupport() {
  ...
  useEffect(() => {
    document.title = "Work Support | Practical Technical & Career Guidance";
    const description = "Work Support provides practical technical guidance, project support, structured training and professional skill development to help you solve problems and move forward.";
