  ...
  return (
    <section className="relative overflow-hidden bg-bg">
      ...
      <div className="relative mx-auto max-w-8xl px-6 py-16 sm:py-20 lg:px-10 lg:py-24">
        ...
        <h1 className="hero-h1-l1 max-w-2xl text-[36px] font-extrabold leading-[1.1] tracking-tight text-navy sm:text-[48px]">
          {title}
        </h1>
        <p className="hero-desc mt-5 max-w-[560px] text-[16px] leading-[1.7] text-text-muted sm:text-[17px]">
          {description}
        </p>
